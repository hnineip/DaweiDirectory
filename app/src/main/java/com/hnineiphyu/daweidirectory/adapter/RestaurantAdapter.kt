...
import com.hnineiphyu.daweidirectory.ui.restaurant.RestaurantFragment
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.item_restaurant.view.*

class RestaurantAdapter(var restruantList: ArrayList<InfosItem> = ArrayList()) :
    RecyclerView.Adapter<RestaurantAdapter.RestrauantViewHolder>() {
    ...
    fun setOnClickListener(clickListenter: RestaurantFragment) {
    ...
    inner class RestrauantViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        fun bindRestruant(infosItem: InfosItem){
            ...
            view.restaurant_name.text = infosItem.title
        }
